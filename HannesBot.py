...
def csv_to_pdf(df, output_file):
    ...
    # Artikel zusammenfassen inkl. ME
    summary = df.groupby(["Pos-Bezeichnung", "ME"], as_index=False)["Auftragsmenge"].sum()
    ...
    pdf.cell(40, 10, "ME", border=1, ln=True)
    ...
    for index, row in summary.iterrows():
        ...
        pdf.cell(40, 10, row["ME"], border=1, ln=True)
